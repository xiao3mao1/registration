...
<form method="POST" action="controllers/upload_dop_ball_controller.php" enctype="multipart/form-data">
    <div>
 ...
 <label>Документ:</label>
  <div > 
     <input name="dop_ball_name" type="text"  required placeholder="Название документа"><br>
 <input name="dop_ball" type="file" required class='add_lgota'><br>
  </div> 
  </div>
